-- ============================================================================
-- MDC SYSTEM 2: Period-Based Saved Records Migration
-- Creates the saved_records table to store self-contained historical snapshots
-- of Forecasting and Allocation Matrices per period (Month/Week/Year).
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS saved_records (
    ...
    snapshot_data JSONB NOT NULL DEFAULT '{}'::jsonb, -- contains forecastItems, allocations, parts, sites, summary
...
-- Permissive policies aligned with existing MDC System 2 access model
DO $$ BEGIN
